        ...
        try:
            ...
            def aggregate_group(g):
                ...
                result_dict = {
                    ...
                    'main_cust_addr': g['main_cust_addr'].iloc[0] if 'main_cust_addr' in g.columns else '',
                    'main_cust_phone_number': g['main_cust_phone_number'].iloc[0] if 'main_cust_phone_number' in g.columns else '',
